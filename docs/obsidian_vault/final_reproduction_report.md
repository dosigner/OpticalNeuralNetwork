...
| Figure | 설명 | 위치 |
|---|---|---|
| **Fig. 2.1** | 상관길이 vs smoothing sigma + 최대 산란각 | ![[images/fig_correlation_physics.png\|300]] |
| **Fig. 3.1** | D2NN 광학 시스템 측면 기하 배치 | ![[images/fig_system_geometry.png\|300]] |
| **Fig. 4.1** | PCC+Energy loss 설계 다이어그램 | ![[images/fig_loss_landscape.png\|300]] |
| **Fig. 5.1** | Known/New PCC 비교 + n별 추이 | ![[images/fig_training_comparison.png\|300]] |
| **Fig. 6.1** | 30개 암묵지 분류 인포그래픽 | ![[images/fig_tacit_knowledge_map.png\|300]] |
| **Fig. 7.1** | 응용 도메인별 TRL 로드맵 | ![[images/fig_application_roadmap.png\|300]] |
