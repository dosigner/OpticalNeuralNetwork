...
*파일 위치*: `tao2019_fourier_space_d2nn/reports/final_report_fd2nn.md`
...
| 파일 | 내용 | 관련 섹션 |
|---|---|---|
| `fig4a_per_sample_minmax_comparison.png` | 4종 config 수렴 곡선 (per_sample_minmax) | 4.1 |
| `fig4a_mnist_bs10_reproduction_f1mm.png` | bs=10, f=1mm MNIST 재현 | 4.1 |
| `fig4b_mnist_bs1024_convergence.png` | Fig 4(b) bs=1024 수렴 | 4.2 |
| `fig4b_mnist_bs10_convergence.png` | Fig 4(b) bs=10 수렴 | 4.2 |
| `supp_s7a_accuracy_vs_layers.png` | Layer 수 vs 정확도 | 4.3, 5.5 |
| `supp_s7b_sbn_position.png` | SBN Front vs Rear 비교 | 4.3, 5.4 |
| `supp_s7c_mnist_1l_convergence.png` | 1-layer 수렴 곡선 | 4.3 |
| `supp_s7d_mnist_5l_convergence.png` | 5-layer 수렴 곡선 | 4.3 |
| `supp_s7cd_mnist_convergence.png` | S7(c/d) 통합 | 4.3 |
| `cifar10_2f_physical_vs_ideal.png` | 2f physical vs ideal | 7.5 |
...
> ```
>
> 환경: PyTorch 2.x, CUDA, seed=42. 단일 GPU로 충분.
> 5L 30-epoch 실험은 ~30분 (bs=10), ~5분 (bs=1024) 소요.
...
6. **Fig S8 미재현**: Fabrication imprecision/alignment error robustness 미실험
